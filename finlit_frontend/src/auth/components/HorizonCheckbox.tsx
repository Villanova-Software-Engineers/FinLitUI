...
const Checkbox = (props: CheckboxProps) => {
  const { extra, color, checked, onChange, disabled, ...rest } = props;
  return (
    <input
      type="checkbox"
      checked={checked}
      ...
      justify-center rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-navy-800 text-white/0 outline-none transition duration-[0.2s]
